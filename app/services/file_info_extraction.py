...
async def get_gpt_response(text: str, prompt: str) -> str:
    try:
        ...
        # Remove ```json and ``` if they exist at the start and end of the content
...
async def extract_fields_user_v1(text: str) -> Dict[str, Any]:
    ...
    response = await get_gpt_response(text, prompt)
