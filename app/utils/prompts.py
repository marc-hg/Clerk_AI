...
Provide the following in JSON format: name, email, country, phone, skills (with a score from 0 to 100), and an overall comment. Use very high standards for scoring. Only high scores should be given for truly exceptional candidates. Reply ONLY with the JSON, nothing else.
